...
public class AffinityGroupHostLabelServiceImpl extends ServiceImpl implements AffinityGroupHostLabelService {
    
    public AffinityGroupHostLabelServiceImpl(HttpConnection connection, String path) {
    ...
    public String toString() {
        return "AffinityGroupHostLabelService:" + getPath();
    }
