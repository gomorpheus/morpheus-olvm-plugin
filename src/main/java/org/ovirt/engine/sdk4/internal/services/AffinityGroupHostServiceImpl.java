...
public class AffinityGroupHostServiceImpl extends ServiceImpl implements AffinityGroupHostService {
    
    public AffinityGroupHostServiceImpl(HttpConnection connection, String path) {
    ...
    public String toString() {
        return "AffinityGroupHostService:" + getPath();
    }
