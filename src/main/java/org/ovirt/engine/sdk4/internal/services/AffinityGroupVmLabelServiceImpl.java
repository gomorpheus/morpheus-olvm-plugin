...
public class AffinityGroupVmLabelServiceImpl extends ServiceImpl implements AffinityGroupVmLabelService {
    
    public AffinityGroupVmLabelServiceImpl(HttpConnection connection, String path) {
    ...
    public String toString() {
        return "AffinityGroupVmLabelService:" + getPath();
    }
