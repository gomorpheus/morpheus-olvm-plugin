...
import org.ovirt.engine.sdk4.services.AffinityGroupVmLabelService;
...
public class AffinityGroupVmLabelsServiceImpl extends ServiceImpl implements AffinityGroupVmLabelsService {
    ...
    public AffinityGroupVmLabelService labelService(String id) {
        return new AffinityGroupVmLabelServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "AffinityGroupVmLabelsService:" + getPath();
    }
