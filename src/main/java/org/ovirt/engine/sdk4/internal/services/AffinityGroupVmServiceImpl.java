...
public class AffinityGroupVmServiceImpl extends ServiceImpl implements AffinityGroupVmService {
    
    public AffinityGroupVmServiceImpl(HttpConnection connection, String path) {
    ...
    public String toString() {
        return "AffinityGroupVmService:" + getPath();
    }
