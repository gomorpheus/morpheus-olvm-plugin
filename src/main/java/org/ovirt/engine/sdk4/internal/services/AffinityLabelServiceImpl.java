...
public class AffinityLabelServiceImpl extends ServiceImpl implements AffinityLabelService {
    ...
    private class UpdateRequestImpl extends BaseRequest<UpdateRequest, UpdateResponse> implements UpdateRequest {
        private AffinityLabel label;
        public UpdateRequest label(AffinityLabel label) {
            this.label = label;
            return this;
        }
        
        public UpdateRequest label(AffinityLabelBuilder label) {
    ...
    public AffinityLabelHostsService hostsService() {
        return new AffinityLabelHostsServiceImpl(getConnection(), getPath() + "/hosts");
    }
    
    public AffinityLabelVmsService vmsService() {
        return new AffinityLabelVmsServiceImpl(getConnection(), getPath() + "/vms");
    }
    ...
    public String toString() {
        return "AffinityLabelService:" + getPath();
    }
