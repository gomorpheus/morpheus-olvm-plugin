...
public class AffinityLabelVmServiceImpl extends ServiceImpl implements AffinityLabelVmService {
    
    public AffinityLabelVmServiceImpl(HttpConnection connection, String path) {
    ...
    public String toString() {
        return "AffinityLabelVmService:" + getPath();
    }
