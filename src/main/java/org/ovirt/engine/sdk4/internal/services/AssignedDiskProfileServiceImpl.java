...
public class AssignedDiskProfileServiceImpl extends ServiceImpl implements AssignedDiskProfileService {
    
    public AssignedDiskProfileServiceImpl(HttpConnection connection, String path) {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.diskProfile(XmlDiskProfileReader.readOne(reader));
    ...
    private class GetResponseImpl implements GetResponse {
        ...
        public void diskProfile(DiskProfile diskProfile) {
    ...
    public String toString() {
        return "AssignedDiskProfileService:" + getPath();
    }
