...
public class AssignedDiskProfilesServiceImpl extends ServiceImpl implements AssignedDiskProfilesService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest profile(DiskProfile profile) {
            this.profile = profile;
            return this;
        }
        
        public AddRequest profile(DiskProfileBuilder profile) {
        ...
        public AddResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlDiskProfileWriter.writeOne(profile, xmlWriter);
                xmlWriter.flush();
    ...
    public AssignedDiskProfileService profileService(String id) {
        return new AssignedDiskProfileServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "AssignedDiskProfilesService:" + getPath();
    }
