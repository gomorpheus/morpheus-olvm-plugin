...
public class AssignedTagServiceImpl extends ServiceImpl implements AssignedTagService {
    
    public AssignedTagServiceImpl(HttpConnection connection, String path) {
    ...
    public String toString() {
        return "AssignedTagService:" + getPath();
    }
