...
public class AssignedVnicProfilesServiceImpl extends ServiceImpl implements AssignedVnicProfilesService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest profile(VnicProfile profile) {
            this.profile = profile;
            return this;
        }
        
        public AddRequest profile(VnicProfileBuilder profile) {
        ...
        public AddResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlVnicProfileWriter.writeOne(profile, xmlWriter);
                xmlWriter.flush();
    ...
    public AssignedVnicProfileService profileService(String id) {
        return new AssignedVnicProfileServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "AssignedVnicProfilesService:" + getPath();
    }
