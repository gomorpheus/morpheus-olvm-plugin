...
public class AttachedStorageDomainDiskServiceImpl extends MeasurableServiceImpl implements AttachedStorageDomainDiskService {
    ...
    public String toString() {
        return "AttachedStorageDomainDiskService:" + getPath();
    }
