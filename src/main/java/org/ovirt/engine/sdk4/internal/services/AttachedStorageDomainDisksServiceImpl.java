...
public class AttachedStorageDomainDisksServiceImpl extends ServiceImpl implements AttachedStorageDomainDisksService {
    ...
    public AttachedStorageDomainDiskService diskService(String id) {
        return new AttachedStorageDomainDiskServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "AttachedStorageDomainDisksService:" + getPath();
    }
