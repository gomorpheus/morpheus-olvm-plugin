...
public class BookmarksServiceImpl extends ServiceImpl implements BookmarksService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest bookmark(Bookmark bookmark) {
            this.bookmark = bookmark;
            return this;
        }
        
        public AddRequest bookmark(BookmarkBuilder bookmark) {
        ...
        public AddResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlBookmarkWriter.writeOne(bookmark, xmlWriter);
                xmlWriter.flush();
    ...
    public BookmarkService bookmarkService(String id) {
        return new BookmarkServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        return bookmarkService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "BookmarksService:" + getPath();
    }
