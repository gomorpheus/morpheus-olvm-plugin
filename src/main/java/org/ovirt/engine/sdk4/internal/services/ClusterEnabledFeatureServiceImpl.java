...
public class ClusterEnabledFeatureServiceImpl extends ServiceImpl implements ClusterEnabledFeatureService {
    
    public ClusterEnabledFeatureServiceImpl(HttpConnection connection, String path) {
    ...
    public String toString() {
        return "ClusterEnabledFeatureService:" + getPath();
    }
