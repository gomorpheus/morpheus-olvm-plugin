...
public class ClusterExternalProvidersServiceImpl extends ServiceImpl implements ClusterExternalProvidersService {
    
    public ClusterExternalProvidersServiceImpl(HttpConnection connection, String path) {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.providers(XmlExternalProviderReader.readMany(reader));
    ...
    private class ListResponseImpl implements ListResponse {
        ...
        public void providers(List<ExternalProvider> providers) {
            this.providers = providers;
        }
        
        public List<ExternalProvider> providers() {
            return providers;
        }
    ...
    public String toString() {
        return "ClusterExternalProvidersService:" + getPath();
    }
