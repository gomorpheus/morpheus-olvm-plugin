...
public class ClusterFeatureServiceImpl extends ServiceImpl implements ClusterFeatureService {
    
    public ClusterFeatureServiceImpl(HttpConnection connection, String path) {
    ...
    public String toString() {
        return "ClusterFeatureService:" + getPath();
    }
