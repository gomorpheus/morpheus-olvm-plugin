...
public class ClusterNetworksServiceImpl extends ServiceImpl implements ClusterNetworksService {
    
    public ClusterNetworksServiceImpl(HttpConnection connection, String path) {
    ...
    public ClusterNetworkService networkService(String id) {
        return new ClusterNetworkServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "ClusterNetworksService:" + getPath();
    }
