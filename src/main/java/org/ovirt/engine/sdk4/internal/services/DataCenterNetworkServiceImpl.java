...
public class DataCenterNetworkServiceImpl extends ServiceImpl implements DataCenterNetworkService {
    
    public DataCenterNetworkServiceImpl(HttpConnection connection, String path) {
    ...
    private class UpdateRequestImpl extends BaseRequest<UpdateRequest, UpdateResponse> implements UpdateRequest {
        private Network network;
        public UpdateRequest network(Network network) {
            this.network = network;
            return this;
        }
        
        public UpdateRequest network(NetworkBuilder network) {
    ...
    public String toString() {
        return "DataCenterNetworkService:" + getPath();
    }
