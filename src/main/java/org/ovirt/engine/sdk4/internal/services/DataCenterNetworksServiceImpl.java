...
import org.ovirt.engine.sdk4.services.DataCenterNetworkService;
import org.ovirt.engine.sdk4.services.DataCenterNetworksService;
import org.ovirt.engine.sdk4.types.Network;

public class DataCenterNetworksServiceImpl extends ServiceImpl implements DataCenterNetworksService {
    
    public DataCenterNetworksServiceImpl(HttpConnection connection, String path) {
        super(connection, path);
    }
    
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        private Network network;
        public AddRequest network(Network network) {
            this.network = network;
            return this;
        }
        
        public AddRequest network(NetworkBuilder network) {
        ...
        public AddResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlNetworkWriter.writeOne(network, xmlWriter);
                xmlWriter.flush();
    ...
    public DataCenterNetworkService networkService(String id) {
        return new DataCenterNetworkServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        return networkService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "DataCenterNetworksService:" + getPath();
    }
