...
public class DiskProfilesServiceImpl extends ServiceImpl implements DiskProfilesService {
    ...
    public DiskProfileService diskProfileService(String id) {
        return new DiskProfileServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        return diskProfileService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "DiskProfilesService:" + getPath();
    }
