...
public class DomainUserGroupsServiceImpl extends ServiceImpl implements DomainUserGroupsService {
    
    public DomainUserGroupsServiceImpl(HttpConnection connection, String path) {
    ...
    public String toString() {
        return "DomainUserGroupsService:" + getPath();
    }
