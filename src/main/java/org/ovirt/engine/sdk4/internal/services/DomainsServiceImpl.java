...
public class DomainsServiceImpl extends ServiceImpl implements DomainsService {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.domains(XmlDomainReader.readMany(reader));
    ...
    private class ListResponseImpl implements ListResponse {
        ...
        public void domains(List<Domain> domains) {
    ...
    public DomainService domainService(String id) {
        return new DomainServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        return domainService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "DomainsService:" + getPath();
    }
