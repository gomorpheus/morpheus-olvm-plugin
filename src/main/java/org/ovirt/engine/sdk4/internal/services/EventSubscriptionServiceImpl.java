...
public class EventSubscriptionServiceImpl extends ServiceImpl implements EventSubscriptionService {
    
    public EventSubscriptionServiceImpl(HttpConnection connection, String path) {
    ...
    public String toString() {
        return "EventSubscriptionService:" + getPath();
    }
