...
public class ExternalComputeResourceServiceImpl extends ServiceImpl implements ExternalComputeResourceService {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.resource(XmlExternalComputeResourceReader.readOne(reader));
    ...
    private class GetResponseImpl implements GetResponse {
        private ExternalComputeResource resource;
        
        public void resource(ExternalComputeResource resource) {
            this.resource = resource;
        }
        
        public ExternalComputeResource resource() {
            return resource;
        }
    ...
    public String toString() {
        return "ExternalComputeResourceService:" + getPath();
    }
