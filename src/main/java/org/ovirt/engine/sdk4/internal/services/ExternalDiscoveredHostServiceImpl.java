...
public class ExternalDiscoveredHostServiceImpl extends ServiceImpl implements ExternalDiscoveredHostService {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.host(XmlExternalDiscoveredHostReader.readOne(reader));
    ...
    private class GetResponseImpl implements GetResponse {
        private ExternalDiscoveredHost host;
        
        public void host(ExternalDiscoveredHost host) {
            this.host = host;
        }
        
        public ExternalDiscoveredHost host() {
            return host;
        }
    ...
    public String toString() {
        return "ExternalDiscoveredHostService:" + getPath();
    }
