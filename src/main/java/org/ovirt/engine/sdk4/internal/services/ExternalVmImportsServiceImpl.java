...
public class ExternalVmImportsServiceImpl extends ServiceImpl implements ExternalVmImportsService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest import_(ExternalVmImport import_) {
            this.import_ = import_;
            return this;
        }
        
        public AddRequest import_(ExternalVmImportBuilder import_) {
        ...
        public AddResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlExternalVmImportWriter.writeOne(import_, xmlWriter);
                xmlWriter.flush();
    ...
    public String toString() {
        return "ExternalVmImportsService:" + getPath();
    }
