...
public class FenceAgentsServiceImpl extends ServiceImpl implements FenceAgentsService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        private Agent agent;
        public AddRequest agent(Agent agent) {
            this.agent = agent;
            return this;
        }
        
        public AddRequest agent(AgentBuilder agent) {
        ...
        public AddResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlAgentWriter.writeOne(agent, xmlWriter);
                xmlWriter.flush();
    ...
    public FenceAgentService agentService(String id) {
        return new FenceAgentServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        if (index == -1) {
            return agentService(path);
        }
        return agentService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "FenceAgentsService:" + getPath();
    }
