...
public class FilterServiceImpl extends ServiceImpl implements FilterService {
    ...
    public FilterServiceImpl(HttpConnection connection, String path) {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.result(XmlFilterReader.readOne(reader));
    ...
    private class GetResponseImpl implements GetResponse {
        ...
        public void result(Filter result) {
            this.result = result;
        }
