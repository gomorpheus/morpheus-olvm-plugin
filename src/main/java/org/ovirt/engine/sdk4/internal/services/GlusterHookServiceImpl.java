...
public class GlusterHookServiceImpl extends ServiceImpl implements GlusterHookService {
    ...
    private class DisableRequestImpl extends BaseRequest<DisableRequest, DisableResponse> implements DisableRequest {
    ...
    private class EnableRequestImpl extends BaseRequest<EnableRequest, EnableResponse> implements EnableRequest {
        private Boolean async;
    ...
    private class ResolveRequestImpl extends BaseRequest<ResolveRequest, ResolveResponse> implements ResolveRequest {
        private Boolean async;
