...
public class GroupsServiceImpl extends ServiceImpl implements GroupsService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        private Group group;
        public AddRequest group(Group group) {
            this.group = group;
            return this;
        }
        
        public AddRequest group(GroupBuilder group) {
        ...
        public AddResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlGroupWriter.writeOne(group, xmlWriter);
                xmlWriter.flush();
    ...
    public GroupService groupService(String id) {
        return new GroupServiceImpl(getConnection(), getPath() + "/" + id);
    }
