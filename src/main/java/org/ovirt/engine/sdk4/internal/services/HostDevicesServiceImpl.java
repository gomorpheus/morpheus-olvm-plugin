...
import org.ovirt.engine.sdk4.services.HostDeviceService;
import org.ovirt.engine.sdk4.services.HostDevicesService;
import org.ovirt.engine.sdk4.types.HostDevice;

public class HostDevicesServiceImpl extends ServiceImpl implements HostDevicesService {
    
    public HostDevicesServiceImpl(HttpConnection connection, String path) {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.devices(XmlHostDeviceReader.readMany(reader));
    ...
    private class ListResponseImpl implements ListResponse {
        ...
        public void devices(List<HostDevice> devices) {
    ...
    public HostDeviceService deviceService(String id) {
        return new HostDeviceServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        if (index == -1) {
            return deviceService(path);
        }
        return deviceService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "HostDevicesService:" + getPath();
    }
