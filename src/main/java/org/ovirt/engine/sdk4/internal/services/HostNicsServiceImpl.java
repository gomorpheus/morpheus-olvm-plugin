...
public class HostNicsServiceImpl extends ServiceImpl implements HostNicsService {
    
    public HostNicsServiceImpl(HttpConnection connection, String path) {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.nics(XmlHostNicReader.readMany(reader));
    ...
    private class ListResponseImpl implements ListResponse {
        ...
        public void nics(List<HostNic> nics) {
            this.nics = nics;
        }
    ...
    public HostNicService nicService(String id) {
        return new HostNicServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "HostNicsService:" + getPath();
    }
