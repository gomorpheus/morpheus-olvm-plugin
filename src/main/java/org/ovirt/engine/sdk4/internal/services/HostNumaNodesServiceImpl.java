...
public class HostNumaNodesServiceImpl extends ServiceImpl implements HostNumaNodesService {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.nodes(XmlNumaNodeReader.readMany(reader));
    ...
    private class ListResponseImpl implements ListResponse {
        ...
        public void nodes(List<NumaNode> nodes) {
            this.nodes = nodes;
        }
    ...
    public HostNumaNodeService nodeService(String id) {
        return new HostNumaNodeServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        return nodeService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "HostNumaNodesService:" + getPath();
    }
