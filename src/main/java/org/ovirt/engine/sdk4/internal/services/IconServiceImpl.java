...
import org.ovirt.engine.sdk4.internal.xml.XmlIconReader;
import org.ovirt.engine.sdk4.services.IconService;
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.icon(XmlIconReader.readOne(reader));
