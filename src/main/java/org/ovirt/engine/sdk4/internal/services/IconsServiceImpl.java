...
public class IconsServiceImpl extends ServiceImpl implements IconsService {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.icons(XmlIconReader.readMany(reader));
    ...
    private class ListResponseImpl implements ListResponse {
        ...
        public void icons(List<Icon> icons) {
            this.icons = icons;
        }
    ...
    public IconService iconService(String id) {
        return new IconServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        return iconService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "IconsService:" + getPath();
    }
