...
public class InstanceTypeGraphicsConsoleServiceImpl extends ServiceImpl implements InstanceTypeGraphicsConsoleService {
    
    public InstanceTypeGraphicsConsoleServiceImpl(HttpConnection connection, String path) {
    ...
    public String toString() {
        return "InstanceTypeGraphicsConsoleService:" + getPath();
    }
