...
import org.ovirt.engine.sdk4.services.InstanceTypeGraphicsConsoleService;
...
public class InstanceTypeGraphicsConsolesServiceImpl extends ServiceImpl implements InstanceTypeGraphicsConsolesService {
    
    public InstanceTypeGraphicsConsolesServiceImpl(HttpConnection connection, String path) {
    ...
    public InstanceTypeGraphicsConsoleService consoleService(String id) {
        return new InstanceTypeGraphicsConsoleServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "InstanceTypeGraphicsConsolesService:" + getPath();
    }
