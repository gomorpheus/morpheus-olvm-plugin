...
public class InstanceTypeWatchdogServiceImpl extends ServiceImpl implements InstanceTypeWatchdogService {
    
    public InstanceTypeWatchdogServiceImpl(HttpConnection connection, String path) {
    ...
    private class UpdateRequestImpl extends BaseRequest<UpdateRequest, UpdateResponse> implements UpdateRequest {
        ...
        private Watchdog watchdog;
        public UpdateRequest watchdog(Watchdog watchdog) {
            this.watchdog = watchdog;
            return this;
        }
        
        public UpdateRequest watchdog(WatchdogBuilder watchdog) {
    ...
    public String toString() {
        return "InstanceTypeWatchdogService:" + getPath();
    }
