...
public class InstanceTypesServiceImpl extends ServiceImpl implements InstanceTypesService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest instanceType(InstanceType instanceType) {
            this.instanceType = instanceType;
            return this;
        }
        
        public AddRequest instanceType(InstanceTypeBuilder instanceType) {
    ...
    public InstanceTypeService instanceTypeService(String id) {
        return new InstanceTypeServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        return instanceTypeService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "InstanceTypesService:" + getPath();
    }
