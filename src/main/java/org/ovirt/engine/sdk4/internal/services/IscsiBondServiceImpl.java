...
public class IscsiBondServiceImpl extends ServiceImpl implements IscsiBondService {
    ...
    private class UpdateRequestImpl extends BaseRequest<UpdateRequest, UpdateResponse> implements UpdateRequest {
        ...
        private IscsiBond bond;
        public UpdateRequest bond(IscsiBond bond) {
            this.bond = bond;
            return this;
        }
        
        public UpdateRequest bond(IscsiBondBuilder bond) {
    ...
    public StorageServerConnectionsService storageServerConnectionsService() {
        return new StorageServerConnectionsServiceImpl(getConnection(), getPath() + "/storageserverconnections");
    }
    ...
    public Service service(String path) {
        ...
        if (path.startsWith("storageserverconnections/")) {
            return storageServerConnectionsService().service(path.substring(25));
        }
        throw new Error("The path " + path + " doesn't correspond to any service");
    }
    
    public String toString() {
        return "IscsiBondService:" + getPath();
    }
