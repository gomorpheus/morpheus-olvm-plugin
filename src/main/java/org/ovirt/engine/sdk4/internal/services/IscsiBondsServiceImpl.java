...
public class IscsiBondsServiceImpl extends ServiceImpl implements IscsiBondsService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest bond(IscsiBond bond) {
            this.bond = bond;
            return this;
        }
        
        public AddRequest bond(IscsiBondBuilder bond) {
        ...
        public AddResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlIscsiBondWriter.writeOne(bond, xmlWriter);
                xmlWriter.flush();
    ...
    public IscsiBondService iscsiBondService(String id) {
        return new IscsiBondServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        return iscsiBondService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "IscsiBondsService:" + getPath();
    }
