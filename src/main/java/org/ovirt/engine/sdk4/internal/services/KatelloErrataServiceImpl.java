...
public class KatelloErrataServiceImpl extends ServiceImpl implements KatelloErrataService {
    
    public KatelloErrataServiceImpl(HttpConnection connection, String path) {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.errata(XmlKatelloErratumReader.readMany(reader));
    ...
    private class ListResponseImpl implements ListResponse {
        private List<KatelloErratum> errata;
        
        public void errata(List<KatelloErratum> errata) {
            this.errata = errata;
        }
        
        public List<KatelloErratum> errata() {
            return errata;
        }
    ...
    public String toString() {
        return "KatelloErrataService:" + getPath();
    }
