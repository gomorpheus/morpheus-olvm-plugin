...
public class LinkLayerDiscoveryProtocolServiceImpl extends ServiceImpl implements LinkLayerDiscoveryProtocolService {
    ...
    public String toString() {
        return "LinkLayerDiscoveryProtocolService:" + getPath();
    }
