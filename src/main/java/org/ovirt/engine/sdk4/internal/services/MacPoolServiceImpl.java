...
public class MacPoolServiceImpl extends ServiceImpl implements MacPoolService {
    ...
    private class UpdateRequestImpl extends BaseRequest<UpdateRequest, UpdateResponse> implements UpdateRequest {
        ...
        private MacPool pool;
        public UpdateRequest pool(MacPool pool) {
            this.pool = pool;
            return this;
        }
        
        public UpdateRequest pool(MacPoolBuilder pool) {
        ...
        public UpdateResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlMacPoolWriter.writeOne(pool, xmlWriter);
                xmlWriter.flush();
