...
public class MacPoolsServiceImpl extends ServiceImpl implements MacPoolsService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest pool(MacPool pool) {
            this.pool = pool;
            return this;
        }
        
        public AddRequest pool(MacPoolBuilder pool) {
    ...
    public MacPoolService macPoolService(String id) {
        return new MacPoolServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        return macPoolService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "MacPoolsService:" + getPath();
    }
