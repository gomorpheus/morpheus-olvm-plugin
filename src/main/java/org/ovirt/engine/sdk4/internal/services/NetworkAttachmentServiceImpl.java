...
public class NetworkAttachmentServiceImpl extends ServiceImpl implements NetworkAttachmentService {
    ...
    private class UpdateRequestImpl extends BaseRequest<UpdateRequest, UpdateResponse> implements UpdateRequest {
        ...
        private NetworkAttachment attachment;
        public UpdateRequest attachment(NetworkAttachment attachment) {
            this.attachment = attachment;
            return this;
        }
        
        public UpdateRequest attachment(NetworkAttachmentBuilder attachment) {
    ...
    public String toString() {
        return "NetworkAttachmentService:" + getPath();
    }
