...
public class NetworkAttachmentsServiceImpl extends ServiceImpl implements NetworkAttachmentsService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest attachment(NetworkAttachment attachment) {
            this.attachment = attachment;
            return this;
        }
        
        public AddRequest attachment(NetworkAttachmentBuilder attachment) {
        ...
        public AddResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlNetworkAttachmentWriter.writeOne(attachment, xmlWriter);
                xmlWriter.flush();
    ...
    public NetworkAttachmentService attachmentService(String id) {
        return new NetworkAttachmentServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "NetworkAttachmentsService:" + getPath();
    }
