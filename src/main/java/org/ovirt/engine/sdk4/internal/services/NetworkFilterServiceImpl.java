...
public class NetworkFilterServiceImpl extends ServiceImpl implements NetworkFilterService {
    
    public NetworkFilterServiceImpl(HttpConnection connection, String path) {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.networkFilter(XmlNetworkFilterReader.readOne(reader));
    ...
    private class GetResponseImpl implements GetResponse {
        ...
        public void networkFilter(NetworkFilter networkFilter) {
    ...
    public String toString() {
        return "NetworkFilterService:" + getPath();
    }
