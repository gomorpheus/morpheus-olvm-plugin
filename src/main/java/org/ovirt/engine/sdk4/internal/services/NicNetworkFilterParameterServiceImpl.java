...
public class NicNetworkFilterParameterServiceImpl extends ServiceImpl implements NicNetworkFilterParameterService {
    
    public NicNetworkFilterParameterServiceImpl(HttpConnection connection, String path) {
    ...
    private class UpdateRequestImpl extends BaseRequest<UpdateRequest, UpdateResponse> implements UpdateRequest {
        private NetworkFilterParameter parameter;
        public UpdateRequest parameter(NetworkFilterParameter parameter) {
            this.parameter = parameter;
            return this;
        }
        
        public UpdateRequest parameter(NetworkFilterParameterBuilder parameter) {
        ...
        public UpdateResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlNetworkFilterParameterWriter.writeOne(parameter, xmlWriter);
                xmlWriter.flush();
    ...
    public String toString() {
        return "NicNetworkFilterParameterService:" + getPath();
    }
