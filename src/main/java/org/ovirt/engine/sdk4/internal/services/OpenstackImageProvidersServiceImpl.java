...
public class OpenstackImageProvidersServiceImpl extends ServiceImpl implements OpenstackImageProvidersService {
    
    public OpenstackImageProvidersServiceImpl(HttpConnection connection, String path) {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest provider(OpenStackImageProvider provider) {
            this.provider = provider;
            return this;
        }
        
        public AddRequest provider(OpenStackImageProviderBuilder provider) {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.providers(XmlOpenStackImageProviderReader.readMany(reader));
                    return actionResponse;
                }
                catch (IOException ex) {
                    throw new Error("Failed to read response", ex);
    ...
    private class ListResponseImpl implements ListResponse {
        private List<OpenStackImageProvider> providers;
        
        public void providers(List<OpenStackImageProvider> providers) {
            this.providers = providers;
        }
        
        public List<OpenStackImageProvider> providers() {
            return providers;
        }
    ...
    public OpenstackImageProviderService providerService(String id) {
        return new OpenstackImageProviderServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "OpenstackImageProvidersService:" + getPath();
    }
