...
import org.ovirt.engine.sdk4.services.OpenstackImageService;
...
public class OpenstackImageServiceImpl extends ServiceImpl implements OpenstackImageService {
    
    public OpenstackImageServiceImpl(HttpConnection connection, String path) {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.image(XmlOpenStackImageReader.readOne(reader));
    ...
    private class GetResponseImpl implements GetResponse {
        private OpenStackImage image;
        
        public void image(OpenStackImage image) {
            this.image = image;
        }
        
        public OpenStackImage image() {
            return image;
        }
    ...
    public String toString() {
        return "OpenstackImageService:" + getPath();
    }
