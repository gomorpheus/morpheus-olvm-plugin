...
public class OpenstackImagesServiceImpl extends ServiceImpl implements OpenstackImagesService {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.images(XmlOpenStackImageReader.readMany(reader));
    ...
    private class ListResponseImpl implements ListResponse {
        ...
        public void images(List<OpenStackImage> images) {
            this.images = images;
        }
    ...
    public OpenstackImageService imageService(String id) {
        return new OpenstackImageServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        return imageService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "OpenstackImagesService:" + getPath();
    }
