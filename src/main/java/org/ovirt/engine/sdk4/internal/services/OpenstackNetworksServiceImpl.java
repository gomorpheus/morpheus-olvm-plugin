...
public class OpenstackNetworksServiceImpl extends ServiceImpl implements OpenstackNetworksService {
    
    public OpenstackNetworksServiceImpl(HttpConnection connection, String path) {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.networks(XmlOpenStackNetworkReader.readMany(reader));
    ...
    private class ListResponseImpl implements ListResponse {
        ...
        public void networks(List<OpenStackNetwork> networks) {
    ...
    public OpenstackNetworkService networkService(String id) {
        return new OpenstackNetworkServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "OpenstackNetworksService:" + getPath();
    }
