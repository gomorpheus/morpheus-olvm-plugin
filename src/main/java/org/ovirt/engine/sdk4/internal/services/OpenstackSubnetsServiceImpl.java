...
public class OpenstackSubnetsServiceImpl extends ServiceImpl implements OpenstackSubnetsService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest subnet(OpenStackSubnet subnet) {
            this.subnet = subnet;
            return this;
        }
        
        public AddRequest subnet(OpenStackSubnetBuilder subnet) {
        ...
        public AddResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlOpenStackSubnetWriter.writeOne(subnet, xmlWriter);
                xmlWriter.flush();
    ...
    public OpenstackSubnetService subnetService(String id) {
        return new OpenstackSubnetServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        if (index == -1) {
            return subnetService(path);
        }
        return subnetService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "OpenstackSubnetsService:" + getPath();
    }
