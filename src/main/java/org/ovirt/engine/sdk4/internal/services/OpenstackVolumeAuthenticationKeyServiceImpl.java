...
public class OpenstackVolumeAuthenticationKeyServiceImpl extends ServiceImpl implements OpenstackVolumeAuthenticationKeyService {
    ...
    private class UpdateRequestImpl extends BaseRequest<UpdateRequest, UpdateResponse> implements UpdateRequest {
        private OpenstackVolumeAuthenticationKey key;
        public UpdateRequest key(OpenstackVolumeAuthenticationKey key) {
            this.key = key;
            return this;
        }
        
        public UpdateRequest key(OpenstackVolumeAuthenticationKeyBuilder key) {
            this.key = key.build();
            return this;
        }
        ...
        public UpdateResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlOpenstackVolumeAuthenticationKeyWriter.writeOne(key, xmlWriter);
                xmlWriter.flush();
    ...
    public String toString() {
        return "OpenstackVolumeAuthenticationKeyService:" + getPath();
    }
