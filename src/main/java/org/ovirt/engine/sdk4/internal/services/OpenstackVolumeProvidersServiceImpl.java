...
public class OpenstackVolumeProvidersServiceImpl extends ServiceImpl implements OpenstackVolumeProvidersService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest provider(OpenStackVolumeProvider provider) {
            this.provider = provider;
            return this;
        }
        
        public AddRequest provider(OpenStackVolumeProviderBuilder provider) {
    ...
    public OpenstackVolumeProviderService providerService(String id) {
        return new OpenstackVolumeProviderServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "OpenstackVolumeProvidersService:" + getPath();
    }
