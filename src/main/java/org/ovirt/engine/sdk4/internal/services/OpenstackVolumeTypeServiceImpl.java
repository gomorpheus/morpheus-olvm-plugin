...
public class OpenstackVolumeTypeServiceImpl extends ServiceImpl implements OpenstackVolumeTypeService {
    
    public OpenstackVolumeTypeServiceImpl(HttpConnection connection, String path) {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.type(XmlOpenStackVolumeTypeReader.readOne(reader));
    ...
    private class GetResponseImpl implements GetResponse {
        private OpenStackVolumeType type;
        
        public void type(OpenStackVolumeType type) {
            this.type = type;
        }
        
        public OpenStackVolumeType type() {
            return type;
        }
    ...
    public String toString() {
        return "OpenstackVolumeTypeService:" + getPath();
    }
