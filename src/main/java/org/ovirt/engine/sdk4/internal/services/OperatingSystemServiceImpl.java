...
public class OperatingSystemServiceImpl extends ServiceImpl implements OperatingSystemService {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.operatingSystem(XmlOperatingSystemInfoReader.readOne(reader));
    ...
    private class GetResponseImpl implements GetResponse {
        ...
        public void operatingSystem(OperatingSystemInfo operatingSystem) {
    ...
    public String toString() {
        return "OperatingSystemService:" + getPath();
    }
