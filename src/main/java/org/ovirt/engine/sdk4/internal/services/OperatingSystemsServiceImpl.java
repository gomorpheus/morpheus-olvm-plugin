...
public class OperatingSystemsServiceImpl extends ServiceImpl implements OperatingSystemsService {
    ...
    public OperatingSystemService operatingSystemService(String id) {
        return new OperatingSystemServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        return operatingSystemService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "OperatingSystemsService:" + getPath();
    }
