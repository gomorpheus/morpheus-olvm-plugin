...
import org.ovirt.engine.sdk4.internal.xml.XmlPermitWriter;
import org.ovirt.engine.sdk4.services.PermitService;
...
public class PermitsServiceImpl extends ServiceImpl implements PermitsService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest permit(Permit permit) {
            this.permit = permit;
            return this;
        }
        
        public AddRequest permit(PermitBuilder permit) {
            this.permit = permit.build();
            return this;
        }
        ...
        public AddResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlPermitWriter.writeOne(permit, xmlWriter);
                xmlWriter.flush();
              ...
              || response.getStatusLine().getStatusCode() == 202
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.permit(XmlPermitReader.readOne(reader));
    ...
    private class AddResponseImpl implements AddResponse {
        ...
        public void permit(Permit permit) {
            this.permit = permit;
        }
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.permits(XmlPermitReader.readMany(reader));
                    return actionResponse;
                }
                catch (IOException ex) {
                    throw new Error("Failed to read response", ex);
    ...
    private class ListResponseImpl implements ListResponse {
        ...
        public void permits(List<Permit> permits) {
    ...
    public PermitService permitService(String id) {
        return new PermitServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        return permitService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "PermitsService:" + getPath();
    }
