...
import org.ovirt.engine.sdk4.internal.xml.XmlQosWriter;
import org.ovirt.engine.sdk4.services.QosService;
...
public class QosServiceImpl extends ServiceImpl implements QosService {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.qos(XmlQosReader.readOne(reader));
    ...
    private class UpdateRequestImpl extends BaseRequest<UpdateRequest, UpdateResponse> implements UpdateRequest {
        ...
        private Qos qos;
        public UpdateRequest qos(Qos qos) {
            this.qos = qos;
            return this;
        }
        
        public UpdateRequest qos(QosBuilder qos) {
            this.qos = qos.build();
            return this;
        }
        ...
        public UpdateResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlQosWriter.writeOne(qos, xmlWriter);
                xmlWriter.flush();
