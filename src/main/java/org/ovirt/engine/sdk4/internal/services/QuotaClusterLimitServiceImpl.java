...
public class QuotaClusterLimitServiceImpl extends ServiceImpl implements QuotaClusterLimitService {
    
    public QuotaClusterLimitServiceImpl(HttpConnection connection, String path) {
    ...
    public String toString() {
        return "QuotaClusterLimitService:" + getPath();
    }
