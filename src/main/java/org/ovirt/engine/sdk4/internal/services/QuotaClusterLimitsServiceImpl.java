...
public class QuotaClusterLimitsServiceImpl extends ServiceImpl implements QuotaClusterLimitsService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest limit(QuotaClusterLimit limit) {
            this.limit = limit;
            return this;
        }
        
        public AddRequest limit(QuotaClusterLimitBuilder limit) {
        ...
        public AddResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlQuotaClusterLimitWriter.writeOne(limit, xmlWriter);
                xmlWriter.flush();
    ...
    public QuotaClusterLimitService limitService(String id) {
        return new QuotaClusterLimitServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "QuotaClusterLimitsService:" + getPath();
    }
