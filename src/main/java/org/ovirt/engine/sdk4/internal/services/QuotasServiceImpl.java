...
public class QuotasServiceImpl extends ServiceImpl implements QuotasService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        private Quota quota;
        public AddRequest quota(Quota quota) {
            this.quota = quota;
            return this;
        }
        
        public AddRequest quota(QuotaBuilder quota) {
    ...
    public QuotaService quotaService(String id) {
        return new QuotaServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        return quotaService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "QuotasService:" + getPath();
    }
