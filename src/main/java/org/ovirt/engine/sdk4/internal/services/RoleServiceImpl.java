...
public class RoleServiceImpl extends ServiceImpl implements RoleService {
    ...
    private class UpdateRequestImpl extends BaseRequest<UpdateRequest, UpdateResponse> implements UpdateRequest {
        ...
        private Role role;
        public UpdateRequest role(Role role) {
            this.role = role;
            return this;
        }
        
        public UpdateRequest role(RoleBuilder role) {
        ...
        public UpdateResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlRoleWriter.writeOne(role, xmlWriter);
                xmlWriter.flush();
    ...
    public PermitsService permitsService() {
        return new PermitsServiceImpl(getConnection(), getPath() + "/permits");
    }
    ...
    public Service service(String path) {
        ...
        if (path.startsWith("permits/")) {
            return permitsService().service(path.substring(8));
        }
        throw new Error("The path " + path + " doesn't correspond to any service");
    }
    
    public String toString() {
        return "RoleService:" + getPath();
    }
