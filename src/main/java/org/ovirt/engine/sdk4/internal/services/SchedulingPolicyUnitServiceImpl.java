...
public class SchedulingPolicyUnitServiceImpl extends ServiceImpl implements SchedulingPolicyUnitService {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.unit(XmlSchedulingPolicyUnitReader.readOne(reader));
    ...
    private class GetResponseImpl implements GetResponse {
        private SchedulingPolicyUnit unit;
        
        public void unit(SchedulingPolicyUnit unit) {
            this.unit = unit;
        }
        
        public SchedulingPolicyUnit unit() {
            return unit;
        }
    ...
    public String toString() {
        return "SchedulingPolicyUnitService:" + getPath();
    }
