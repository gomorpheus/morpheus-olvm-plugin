...
public class SnapshotsServiceImpl extends ServiceImpl implements SnapshotsService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest snapshot(Snapshot snapshot) {
            this.snapshot = snapshot;
            return this;
        }
        
        public AddRequest snapshot(SnapshotBuilder snapshot) {
        ...
        public AddResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlSnapshotWriter.writeOne(snapshot, xmlWriter);
                xmlWriter.flush();
    ...
    public SnapshotService snapshotService(String id) {
        return new SnapshotServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "SnapshotsService:" + getPath();
    }
