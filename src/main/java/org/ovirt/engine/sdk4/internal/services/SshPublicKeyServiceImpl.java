...
public class SshPublicKeyServiceImpl extends ServiceImpl implements SshPublicKeyService {
    ...
    private class UpdateRequestImpl extends BaseRequest<UpdateRequest, UpdateResponse> implements UpdateRequest {
        ...
        private SshPublicKey key;
        public UpdateRequest key(SshPublicKey key) {
            this.key = key;
            return this;
        }
        
        public UpdateRequest key(SshPublicKeyBuilder key) {
            this.key = key.build();
            return this;
        }
        ...
        public UpdateResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlSshPublicKeyWriter.writeOne(key, xmlWriter);
                xmlWriter.flush();
    ...
    public String toString() {
        return "SshPublicKeyService:" + getPath();
    }
