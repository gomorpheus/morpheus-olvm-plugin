...
public class SshPublicKeysServiceImpl extends ServiceImpl implements SshPublicKeysService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest key(SshPublicKey key) {
            this.key = key;
            return this;
        }
        
        public AddRequest key(SshPublicKeyBuilder key) {
            this.key = key.build();
            return this;
        }
    ...
    public SshPublicKeyService keyService(String id) {
        return new SshPublicKeyServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "SshPublicKeysService:" + getPath();
    }
