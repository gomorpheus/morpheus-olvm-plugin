...
import org.ovirt.engine.sdk4.services.StatisticService;
...
public class StatisticsServiceImpl extends ServiceImpl implements StatisticsService {
    ...
    public StatisticsServiceImpl(HttpConnection connection, String path) {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.statistics(XmlStatisticReader.readMany(reader));
    ...
    private class ListResponseImpl implements ListResponse {
        ...
        public void statistics(List<Statistic> statistics) {
    ...
    public StatisticService statisticService(String id) {
        return new StatisticServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        return statisticService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "StatisticsService:" + getPath();
    }
