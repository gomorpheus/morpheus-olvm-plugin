...
public class StorageDomainContentDiskServiceImpl extends ServiceImpl implements StorageDomainContentDiskService {
    ...
    public String toString() {
        return "StorageDomainContentDiskService:" + getPath();
    }
