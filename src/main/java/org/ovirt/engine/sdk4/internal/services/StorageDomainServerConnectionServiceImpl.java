...
public class StorageDomainServerConnectionServiceImpl extends ServiceImpl implements StorageDomainServerConnectionService {
    
    public StorageDomainServerConnectionServiceImpl(HttpConnection connection, String path) {
    ...
    public String toString() {
        return "StorageDomainServerConnectionService:" + getPath();
    }
