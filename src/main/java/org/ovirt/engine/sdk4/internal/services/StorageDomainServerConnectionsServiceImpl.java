...
import org.ovirt.engine.sdk4.services.StorageDomainServerConnectionService;
...
public class StorageDomainServerConnectionsServiceImpl extends ServiceImpl implements StorageDomainServerConnectionsService {
    
    public StorageDomainServerConnectionsServiceImpl(HttpConnection connection, String path) {
    ...
    public StorageDomainServerConnectionService connectionService(String id) {
        return new StorageDomainServerConnectionServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        if (index == -1) {
            return connectionService(path);
        }
        return connectionService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "StorageDomainServerConnectionsService:" + getPath();
    }
