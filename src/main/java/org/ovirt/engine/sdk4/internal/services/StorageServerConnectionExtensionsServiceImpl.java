...
public class StorageServerConnectionExtensionsServiceImpl extends ServiceImpl implements StorageServerConnectionExtensionsService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest extension(StorageConnectionExtension extension) {
            this.extension = extension;
            return this;
        }
        
        public AddRequest extension(StorageConnectionExtensionBuilder extension) {
        ...
        public AddResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlStorageConnectionExtensionWriter.writeOne(extension, xmlWriter);
                xmlWriter.flush();
    ...
    public StorageServerConnectionExtensionService storageConnectionExtensionService(String id) {
        return new StorageServerConnectionExtensionServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        if (index == -1) {
            return storageConnectionExtensionService(path);
        }
        return storageConnectionExtensionService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "StorageServerConnectionExtensionsService:" + getPath();
    }
