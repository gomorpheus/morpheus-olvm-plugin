...
public class StorageServerConnectionsServiceImpl extends ServiceImpl implements StorageServerConnectionsService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest connection(StorageConnection connection) {
            this.connection = connection;
            return this;
        }
        
        public AddRequest connection(StorageConnectionBuilder connection) {
    ...
    private class AddGlusterfsRequestImpl extends BaseRequest<AddGlusterfsRequest, AddGlusterfsResponse> implements AddGlusterfsRequest {
        private StorageConnection connection;
        public AddGlusterfsRequest connection(StorageConnection connection) {
            this.connection = connection;
            return this;
        }
        
        public AddGlusterfsRequest connection(StorageConnectionBuilder connection) {
            this.connection = connection.build();
            return this;
        }
        
        public AddGlusterfsResponse send() {
            HttpPost request = null;
            try {
                URIBuilder uriBuilder = new URIBuilder(getConnection().getUrl() + getPath());
                if (query != null) {
    ...
    private class AddGlusterfsResponseImpl implements AddGlusterfsResponse {
        private StorageConnection connection;
    ...
    public AddGlusterfsRequest addGlusterfs() {
        return new AddGlusterfsRequestImpl();
    }
    
    private class AddIscsiRequestImpl extends BaseRequest<AddIscsiRequest, AddIscsiResponse> implements AddIscsiRequest {
        private StorageConnection connection;
        public AddIscsiRequest connection(StorageConnection connection) {
            this.connection = connection;
            return this;
        }
        
        public AddIscsiRequest connection(StorageConnectionBuilder connection) {
            this.connection = connection.build();
            return this;
        }
        
        public AddIscsiResponse send() {
            HttpPost request = null;
            try {
                URIBuilder uriBuilder = new URIBuilder(getConnection().getUrl() + getPath());
                if (query != null) {
    ...
    private class AddIscsiResponseImpl implements AddIscsiResponse {
        private StorageConnection connection;
    ...
    public AddIscsiRequest addIscsi() {
    ...
    private class AddLocalRequestImpl extends BaseRequest<AddLocalRequest, AddLocalResponse> implements AddLocalRequest {
        private StorageConnection connection;
        public AddLocalRequest connection(StorageConnection connection) {
            this.connection = connection;
            return this;
        }
        
        public AddLocalRequest connection(StorageConnectionBuilder connection) {
            this.connection = connection.build();
            return this;
        }
    ...
    private class AddNfsRequestImpl extends BaseRequest<AddNfsRequest, AddNfsResponse> implements AddNfsRequest {
        private StorageConnection connection;
        public AddNfsRequest connection(StorageConnection connection) {
            this.connection = connection;
            return this;
        }
        
        public AddNfsRequest connection(StorageConnectionBuilder connection) {
            this.connection = connection.build();
            return this;
        }
        
        public AddNfsResponse send() {
            HttpPost request = null;
            try {
                URIBuilder uriBuilder = new URIBuilder(getConnection().getUrl() + getPath());
                if (query != null) {
    ...
    private class AddNfsResponseImpl implements AddNfsResponse {
        private StorageConnection connection;
    ...
    public AddNfsRequest addNfs() {
        return new AddNfsRequestImpl();
    }
    
    private class AddVfsRequestImpl extends BaseRequest<AddVfsRequest, AddVfsResponse> implements AddVfsRequest {
        private StorageConnection connection;
        public AddVfsRequest connection(StorageConnection connection) {
            this.connection = connection;
            return this;
        }
        
        public AddVfsRequest connection(StorageConnectionBuilder connection) {
            this.connection = connection.build();
            return this;
        }
        
        public AddVfsResponse send() {
            HttpPost request = null;
            try {
                URIBuilder uriBuilder = new URIBuilder(getConnection().getUrl() + getPath());
                if (query != null) {
    ...
    private class AddVfsResponseImpl implements AddVfsResponse {
        private StorageConnection connection;
    ...
    public Service service(String path) {
        ...
        if (index == -1) {
            return storageConnectionService(path);
        }
        return storageConnectionService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "StorageServerConnectionsService:" + getPath();
    }
