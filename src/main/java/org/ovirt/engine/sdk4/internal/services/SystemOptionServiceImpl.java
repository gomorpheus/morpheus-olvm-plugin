...
public class SystemOptionServiceImpl extends ServiceImpl implements SystemOptionService {
    ...
    private class GetRequestImpl extends BaseRequest<GetRequest, GetResponse> implements GetRequest {
        ...
        public GetRequest version(String version) {
        ...
        public GetResponse send() {
            ...
            try {
                ...
                if (version != null) {
                    uriBuilder.addParameter("version", XmlWriter.renderString(version));
                }
                if (query != null) {
    ...
    public String toString() {
        return "SystemOptionService:" + getPath();
    }
