...
public class TagServiceImpl extends ServiceImpl implements TagService {
    ...
    public TagServiceImpl(HttpConnection connection, String path) {
    ...
    private class UpdateRequestImpl extends BaseRequest<UpdateRequest, UpdateResponse> implements UpdateRequest {
        ...
        private Tag tag;
        public UpdateRequest tag(Tag tag) {
            this.tag = tag;
            return this;
        }
        
        public UpdateRequest tag(TagBuilder tag) {
            this.tag = tag.build();
            return this;
        }
