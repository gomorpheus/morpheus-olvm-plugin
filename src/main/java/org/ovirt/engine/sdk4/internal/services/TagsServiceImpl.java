...
public class TagsServiceImpl extends ServiceImpl implements TagsService {
    
    public TagsServiceImpl(HttpConnection connection, String path) {
    ...
    public TagService tagService(String id) {
        return new TagServiceImpl(getConnection(), getPath() + "/" + id);
    }
