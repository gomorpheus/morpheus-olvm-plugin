...
import org.ovirt.engine.sdk4.services.TemplateCdromService;
import org.ovirt.engine.sdk4.services.TemplateCdromsService;
import org.ovirt.engine.sdk4.types.Cdrom;

public class TemplateCdromsServiceImpl extends ServiceImpl implements TemplateCdromsService {
    
    public TemplateCdromsServiceImpl(HttpConnection connection, String path) {
    ...
    public TemplateCdromService cdromService(String id) {
        return new TemplateCdromServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        if (index == -1) {
            return cdromService(path);
        }
        return cdromService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "TemplateCdromsService:" + getPath();
    }
