...
public class TemplateDiskAttachmentServiceImpl extends ServiceImpl implements TemplateDiskAttachmentService {
    ...
    private class RemoveRequestImpl extends BaseRequest<RemoveRequest, RemoveResponse> implements RemoveRequest {
        ...
        public RemoveRequest storageDomain(String storageDomain) {
        ...
        public RemoveResponse send() {
            ...
            try {
                ...
                if (storageDomain != null) {
                    uriBuilder.addParameter("storage_domain", XmlWriter.renderString(storageDomain));
                }
                if (query != null) {
                    for (Map.Entry<String, String> queryParam : query.entrySet()) {
                        uriBuilder.addParameter(queryParam.getKey(), queryParam.getValue());
    ...
    public String toString() {
        return "TemplateDiskAttachmentService:" + getPath();
    }
