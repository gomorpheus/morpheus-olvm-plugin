...
import org.ovirt.engine.sdk4.services.TemplateDisksService;
import org.ovirt.engine.sdk4.types.Disk;

public class TemplateDisksServiceImpl extends ServiceImpl implements TemplateDisksService {
    
    public TemplateDisksServiceImpl(HttpConnection connection, String path) {
    ...
    public TemplateDiskService diskService(String id) {
        return new TemplateDiskServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "TemplateDisksService:" + getPath();
    }
