...
public class TemplateGraphicsConsoleServiceImpl extends ServiceImpl implements TemplateGraphicsConsoleService {
    
    public TemplateGraphicsConsoleServiceImpl(HttpConnection connection, String path) {
    ...
    public String toString() {
        return "TemplateGraphicsConsoleService:" + getPath();
    }
