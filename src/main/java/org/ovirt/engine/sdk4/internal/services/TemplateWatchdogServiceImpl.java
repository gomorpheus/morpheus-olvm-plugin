...
public class TemplateWatchdogServiceImpl extends ServiceImpl implements TemplateWatchdogService {
    
    public TemplateWatchdogServiceImpl(HttpConnection connection, String path) {
    ...
    public String toString() {
        return "TemplateWatchdogService:" + getPath();
    }
