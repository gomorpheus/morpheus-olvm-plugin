...
import org.ovirt.engine.sdk4.services.TemplateWatchdogService;
import org.ovirt.engine.sdk4.services.TemplateWatchdogsService;
import org.ovirt.engine.sdk4.types.Watchdog;

public class TemplateWatchdogsServiceImpl extends ServiceImpl implements TemplateWatchdogsService {
    
    public TemplateWatchdogsServiceImpl(HttpConnection connection, String path) {
    ...
    public TemplateWatchdogService watchdogService(String id) {
        return new TemplateWatchdogServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "TemplateWatchdogsService:" + getPath();
    }
