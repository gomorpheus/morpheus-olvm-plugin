...
public class UnmanagedNetworksServiceImpl extends ServiceImpl implements UnmanagedNetworksService {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.networks(XmlUnmanagedNetworkReader.readMany(reader));
    ...
    private class ListResponseImpl implements ListResponse {
        private List<UnmanagedNetwork> networks;
        
        public void networks(List<UnmanagedNetwork> networks) {
            this.networks = networks;
        }
        
        public List<UnmanagedNetwork> networks() {
            return networks;
        }
    ...
    public UnmanagedNetworkService unmanagedNetworkService(String id) {
        return new UnmanagedNetworkServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        return unmanagedNetworkService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "UnmanagedNetworksService:" + getPath();
    }
