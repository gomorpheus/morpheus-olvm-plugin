...
public class UserOptionsServiceImpl extends ServiceImpl implements UserOptionsService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest option(UserOption option) {
            this.option = option;
            return this;
        }
        
        public AddRequest option(UserOptionBuilder option) {
        ...
        public AddResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlUserOptionWriter.writeOne(option, xmlWriter);
                xmlWriter.flush();
    ...
    public UserOptionService optionService(String id) {
        return new UserOptionServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "UserOptionsService:" + getPath();
    }
