...
public class UsersServiceImpl extends ServiceImpl implements UsersService {
    ...
    public UsersServiceImpl(HttpConnection connection, String path) {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest user(UserBuilder user) {
    ...
    public UserService userService(String id) {
        return new UserServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        return userService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "UsersService:" + getPath();
    }
