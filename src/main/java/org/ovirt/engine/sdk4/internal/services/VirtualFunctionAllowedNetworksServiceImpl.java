...
public class VirtualFunctionAllowedNetworksServiceImpl extends ServiceImpl implements VirtualFunctionAllowedNetworksService {
    ...
    public VirtualFunctionAllowedNetworkService networkService(String id) {
        return new VirtualFunctionAllowedNetworkServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "VirtualFunctionAllowedNetworksService:" + getPath();
    }
