...
public class VmBackupDiskServiceImpl extends ServiceImpl implements VmBackupDiskService {
    
    public VmBackupDiskServiceImpl(HttpConnection connection, String path) {
    ...
    public String toString() {
        return "VmBackupDiskService:" + getPath();
    }
