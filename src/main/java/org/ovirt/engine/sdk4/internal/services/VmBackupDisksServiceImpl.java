...
import org.ovirt.engine.sdk4.services.VmBackupDiskService;
import org.ovirt.engine.sdk4.services.VmBackupDisksService;
import org.ovirt.engine.sdk4.types.Disk;

public class VmBackupDisksServiceImpl extends ServiceImpl implements VmBackupDisksService {
    
    public VmBackupDisksServiceImpl(HttpConnection connection, String path) {
    ...
    public VmBackupDiskService diskService(String id) {
        return new VmBackupDiskServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "VmBackupDisksService:" + getPath();
    }
