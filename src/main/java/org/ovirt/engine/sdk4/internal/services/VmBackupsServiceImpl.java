...
public class VmBackupsServiceImpl extends ServiceImpl implements VmBackupsService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest backup(Backup backup) {
            this.backup = backup;
            return this;
        }
        
        public AddRequest backup(BackupBuilder backup) {
            this.backup = backup.build();
            return this;
        }
        
        private Boolean requireConsistency;
        public AddRequest requireConsistency(Boolean requireConsistency) {
        ...
        public AddResponse send() {
            ...
            try {
                ...
                if (requireConsistency != null) {
                    uriBuilder.addParameter("require_consistency", XmlWriter.renderBoolean(requireConsistency));
                }
                if (query != null) {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlBackupWriter.writeOne(backup, xmlWriter);
                xmlWriter.flush();
    ...
    public VmBackupService backupService(String id) {
        return new VmBackupServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        if (index == -1) {
            return backupService(path);
        }
        return backupService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "VmBackupsService:" + getPath();
    }
