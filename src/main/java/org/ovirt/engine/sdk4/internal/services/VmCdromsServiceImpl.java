...
public class VmCdromsServiceImpl extends ServiceImpl implements VmCdromsService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        private Cdrom cdrom;
        public AddRequest cdrom(Cdrom cdrom) {
            this.cdrom = cdrom;
            return this;
        }
        
        public AddRequest cdrom(CdromBuilder cdrom) {
    ...
    public VmCdromService cdromService(String id) {
        return new VmCdromServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "VmCdromsService:" + getPath();
    }
