...
public class VmCheckpointDiskServiceImpl extends ServiceImpl implements VmCheckpointDiskService {
    
    public VmCheckpointDiskServiceImpl(HttpConnection connection, String path) {
    ...
    public String toString() {
        return "VmCheckpointDiskService:" + getPath();
    }
