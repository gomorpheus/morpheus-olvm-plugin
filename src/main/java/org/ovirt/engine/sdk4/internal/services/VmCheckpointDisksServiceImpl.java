...
import org.ovirt.engine.sdk4.services.VmCheckpointDiskService;
import org.ovirt.engine.sdk4.services.VmCheckpointDisksService;
import org.ovirt.engine.sdk4.types.Disk;

public class VmCheckpointDisksServiceImpl extends ServiceImpl implements VmCheckpointDisksService {
    
    public VmCheckpointDisksServiceImpl(HttpConnection connection, String path) {
    ...
    public VmCheckpointDiskService diskService(String id) {
        return new VmCheckpointDiskServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "VmCheckpointDisksService:" + getPath();
    }
