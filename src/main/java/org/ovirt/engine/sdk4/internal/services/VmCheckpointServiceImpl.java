...
import org.ovirt.engine.sdk4.services.VmCheckpointDisksService;
import org.ovirt.engine.sdk4.services.VmCheckpointService;
import org.ovirt.engine.sdk4.types.Checkpoint;

public class VmCheckpointServiceImpl extends ServiceImpl implements VmCheckpointService {
    
    public VmCheckpointServiceImpl(HttpConnection connection, String path) {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.checkpoint(XmlCheckpointReader.readOne(reader));
    ...
    public VmCheckpointDisksService disksService() {
        return new VmCheckpointDisksServiceImpl(getConnection(), getPath() + "/disks");
    }
    ...
    public String toString() {
        return "VmCheckpointService:" + getPath();
    }
