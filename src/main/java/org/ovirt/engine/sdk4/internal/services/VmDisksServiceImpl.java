...
public class VmDisksServiceImpl extends ServiceImpl implements VmDisksService {
    
    public VmDisksServiceImpl(HttpConnection connection, String path) {
    ...
    public VmDiskService diskService(String id) {
        return new VmDiskServiceImpl(getConnection(), getPath() + "/" + id);
    }
