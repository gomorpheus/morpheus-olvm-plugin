...
public class VmGraphicsConsolesServiceImpl extends ServiceImpl implements VmGraphicsConsolesService {
    ...
    private class ListRequestImpl extends BaseRequest<ListRequest, ListResponse> implements ListRequest {
        ...
        public ListRequest current(Boolean current) {
    ...
    public VmGraphicsConsoleService consoleService(String id) {
        return new VmGraphicsConsoleServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "VmGraphicsConsolesService:" + getPath();
    }
