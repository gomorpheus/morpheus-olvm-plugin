...
public class VmHostDevicesServiceImpl extends ServiceImpl implements VmHostDevicesService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest device(HostDevice device) {
            this.device = device;
            return this;
        }
        
        public AddRequest device(HostDeviceBuilder device) {
        ...
        public AddResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlHostDeviceWriter.writeOne(device, xmlWriter);
                xmlWriter.flush();
    ...
    public VmHostDeviceService deviceService(String id) {
        return new VmHostDeviceServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "VmHostDevicesService:" + getPath();
    }
