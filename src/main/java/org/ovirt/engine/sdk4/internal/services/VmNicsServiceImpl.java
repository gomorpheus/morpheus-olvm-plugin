...
public class VmNicsServiceImpl extends ServiceImpl implements VmNicsService {
    
    public VmNicsServiceImpl(HttpConnection connection, String path) {
    ...
    public VmNicService nicService(String id) {
        return new VmNicServiceImpl(getConnection(), getPath() + "/" + id);
    }
