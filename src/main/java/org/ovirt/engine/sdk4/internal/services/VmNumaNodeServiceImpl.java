...
public class VmNumaNodeServiceImpl extends ServiceImpl implements VmNumaNodeService {
    ...
    private class UpdateRequestImpl extends BaseRequest<UpdateRequest, UpdateResponse> implements UpdateRequest {
        ...
        private VirtualNumaNode node;
        public UpdateRequest node(VirtualNumaNode node) {
            this.node = node;
            return this;
        }
        
        public UpdateRequest node(VirtualNumaNodeBuilder node) {
        ...
        public UpdateResponse send() {
            ...
            try (
              ...
              XmlWriter xmlWriter = new XmlWriter(output, true)
                ...
                XmlVirtualNumaNodeWriter.writeOne(node, xmlWriter);
                xmlWriter.flush();
    ...
    public String toString() {
        return "VmNumaNodeService:" + getPath();
    }
