...
public class VmNumaNodesServiceImpl extends ServiceImpl implements VmNumaNodesService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        ...
        public AddRequest node(VirtualNumaNode node) {
            this.node = node;
            return this;
        }
        
        public AddRequest node(VirtualNumaNodeBuilder node) {
    ...
    public VmNumaNodeService nodeService(String id) {
        return new VmNumaNodeServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public String toString() {
        return "VmNumaNodesService:" + getPath();
    }
