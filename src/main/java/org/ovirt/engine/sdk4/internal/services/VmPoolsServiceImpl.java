...
public class VmPoolsServiceImpl extends ServiceImpl implements VmPoolsService {
    ...
    private class AddRequestImpl extends BaseRequest<AddRequest, AddResponse> implements AddRequest {
        private VmPool pool;
        public AddRequest pool(VmPool pool) {
            this.pool = pool;
            return this;
        }
        
        public AddRequest pool(VmPoolBuilder pool) {
    ...
    public VmPoolService poolService(String id) {
        return new VmPoolServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        if (index == -1) {
            return poolService(path);
        }
        return poolService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "VmPoolsService:" + getPath();
    }
