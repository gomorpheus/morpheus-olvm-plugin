...
public class VmReportedDevicesServiceImpl extends ServiceImpl implements VmReportedDevicesService {
              ...
              response.getStatusLine().getStatusCode() == 200
                ...
                try (
                  XmlReader reader = new XmlReader(response.getEntity().getContent())
                    ...
                    actionResponse.reportedDevice(XmlReportedDeviceReader.readMany(reader));
    ...
    private class ListResponseImpl implements ListResponse {
        ...
        public void reportedDevice(List<ReportedDevice> reportedDevice) {
            this.reportedDevice = reportedDevice;
        }
        
        public List<ReportedDevice> reportedDevice() {
    ...
    public VmReportedDeviceService reportedDeviceService(String id) {
        return new VmReportedDeviceServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        if (index == -1) {
            return reportedDeviceService(path);
        }
        return reportedDeviceService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "VmReportedDevicesService:" + getPath();
    }
