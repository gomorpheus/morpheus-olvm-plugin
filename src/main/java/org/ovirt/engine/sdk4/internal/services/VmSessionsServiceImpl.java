...
public class VmSessionsServiceImpl extends ServiceImpl implements VmSessionsService {
    ...
    public VmSessionService sessionService(String id) {
        return new VmSessionServiceImpl(getConnection(), getPath() + "/" + id);
    }
    ...
    public Service service(String path) {
        ...
        if (index == -1) {
            return sessionService(path);
        }
        return sessionService(path.substring(0, index)).service(path.substring(index + 1));
    }
    
    public String toString() {
        return "VmSessionsService:" + getPath();
    }
