...
public class XmlApplicationReader {
    ...
    public static Application readOne(XmlReader reader) {
        ...
        // Create the object:
        ApplicationContainer object = new ApplicationContainer();
    ...
    public static Iterator<Application> iterateMany(final XmlReader reader) {
        return new Iterator<Application>() {
            ...
            public Application next() {
                Application next = readOne(reader);
                if (next == null) {
    ...
    public static List<Application> readMany(XmlReader reader) {
        ...
        Iterator<Application> iterator = iterateMany(reader);
    ...
    private static void processLink(ApplicationContainer object, String[] link) {
    }
}
