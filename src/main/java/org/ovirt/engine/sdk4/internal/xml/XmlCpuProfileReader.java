...
public class XmlCpuProfileReader {
    ...
    public static CpuProfile readOne(XmlReader reader) {
        ...
        // Create the object:
        CpuProfileContainer object = new CpuProfileContainer();
    ...
    public static Iterator<CpuProfile> iterateMany(final XmlReader reader) {
        return new Iterator<CpuProfile>() {
            ...
            @Override
            public CpuProfile next() {
                CpuProfile next = readOne(reader);
                if (next == null) {
    ...
    public static List<CpuProfile> readMany(XmlReader reader) {
        List<CpuProfile> list = new ArrayList<>();
        Iterator<CpuProfile> iterator = iterateMany(reader);
    ...
    private static void processLink(CpuProfileContainer object, String[] link) {
        // Process the attributes:
        ListWithHref list;
        String rel = link[0];
        String href = link[1];
