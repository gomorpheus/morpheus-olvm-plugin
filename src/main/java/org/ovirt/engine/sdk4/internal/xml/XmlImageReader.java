...
public class XmlImageReader {
    ...
    public static Image readOne(XmlReader reader) {
        ...
        while (reader.forward()) {
            ...
            switch (name) {
                ...
                break;
                case "type":
                object.type(XmlImageFileTypeReader.readOne(reader));
                break;
                case "link":
                // Process the attributes:
    ...
    public static List<Image> readMany(XmlReader reader) {
        ...
        Iterator<Image> iterator = iterateMany(reader);
    ...
    private static void processLink(ImageContainer object, String[] link) {
    }
}
